...
import org.jbelt.module.user.internal.CreateUserRequest;
import org.jbelt.module.user.internal.UpdateUserRequest;
...
public class AdminController {
    ...
    public ResponseEntity<UserDto> updateUser(
        ...
        UserDto updated = userService.updateUser(id, request.username(), request.firstName(), request.lastName(), request.roles());
