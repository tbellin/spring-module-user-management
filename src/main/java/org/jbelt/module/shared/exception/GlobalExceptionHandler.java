package org.jbelt.module.shared.exception;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
     ...
     * <p>
     * Catches DB constraint violations (e.g., unique index) that were not caught
     * upstream by application-level duplicate checks, converting them from 500 → 409.
     */
    ...
    public ProblemDetail handleDataIntegrityViolation(DataIntegrityViolationException ex, WebRequest request) {
        ...
        problem.setDetail("A value you entered is already in use.");
        return problem;
    }
